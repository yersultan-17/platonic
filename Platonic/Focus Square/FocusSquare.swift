...
class FocusSquare: SCNNode {
    ...
    static let sideLengthForOpenSquareSegments: CGFloat = 0.2
    
    // Duration of the open/close animation
    static let animationDuration = 0.7
    
    // Color of the focus square
    static let primaryColor = #colorLiteral(red: 0, green: 0.4784313725, blue: 1, alpha: 1)
    static let fillColor = #colorLiteral(red: 0.3527560234, green: 0.6400019526, blue: 0.9096098542, alpha: 1)
    // MARK: - Properties
